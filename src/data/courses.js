export const samplePapersData = [
  {
    id: 1,
    title: "CBSE Class 10 Maths Sample Paper (Standard) 2024",
    class: "10",
    subject: "Maths",
    year: 2024,
    description:
      "Board-style sample paper based on the latest CBSE pattern for Class 10 Maths (Standard).",
    board: "CBSE",
    examType: "Sample",
  ...
  },
  {
    ...
    year: 2024,
    description:
      "Full-length Science sample paper covering Physics, Chemistry and Biology as per latest blueprint.",
    board: "CBSE",
    examType: "Sample",
  ...
  {
    id: 3,
    title: "CBSE Class 10 English Language & Literature Sample Paper 2024",
    class: "10",
    subject: "English",
    year: 2024,
    description:
      "Reading, writing, grammar and literature sections modelled on recent Class 10 English papers.",
    board: "CBSE",
    examType: "Sample",
  ...
  {
    id: 4,
    title: "Class 11 Physics Sample Paper – Term End Exam",
    class: "11",
    subject: "Physics",
    year: 2024,
    description:
      "Numerical and conceptual questions from Mechanics, Waves and Thermodynamics for Class 11 Physics.",
    board: "CBSE",
    examType: "Pre-board",
    tags: ["Class 11", "Physics"],
    fileUrl: "#",
    driveFileId: "sample-drive-id-4",
  },
  {
    id: 5,
    title: "Class 11 Chemistry Sample Paper – Organic & Physical",
    class: "11",
    subject: "Chemistry",
    year: 2024,
    description:
      "Balanced coverage of Organic and Physical Chemistry for Class 11 based on NCERT.",
    board: "CBSE",
    examType: "Sample",
    tags: ["Class 11", "Chemistry"],
    fileUrl: "#",
    driveFileId: "sample-drive-id-5",
  },
  {
    id: 6,
    title: "Class 12 Maths Board Pattern Sample Paper 2024",
    class: "12",
    subject: "Maths",
    year: 2024,
    description:
      "Full syllabus Class 12 Maths paper including Calculus, Vectors and 3D Geometry.",
    board: "CBSE",
    examType: "Final",
    tags: ["Class 12", "Maths", "Board"],
    fileUrl: "#",
    driveFileId: "sample-drive-id-6",
  },
];

export const samplePaperClasses = ["All Classes", "10", "11", "12"];
