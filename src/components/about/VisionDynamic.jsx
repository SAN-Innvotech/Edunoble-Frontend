...
const MOSAIC = [
  "/assets/img/vision-custom/1.jpg",
  "/assets/img/vision-custom/2.jpg",
  "/assets/img/vision-custom/3.jpg",
  "/assets/img/vision-custom/4.jpg",
  "/assets/img/vision-custom/5.jpg",
  "/assets/img/vision-custom/6.jpg",
];
  ...
  useEffect(() => {
    const fetchVisionContent = async () => {
      try {
        ...
        if (!response.ok) throw new Error(`Failed to fetch vision content: ${response.status}`);
